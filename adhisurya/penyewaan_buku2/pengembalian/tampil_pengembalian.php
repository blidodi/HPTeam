...
<body>
	...
	<div id="header">
		<h3><i class="fa fa-retweet" aria-hidden="true"></i> Data Pengembalian Buku</h3>	
	</div>	
	<a class="buttonadd button1" href="input_pengembalian.php" title="Add"><i class="fa fa-plus-square" aria-hidden="true"></i> Add</a>
