...
<body>
	...
	<a class="button button1" href="input_kwitansi.php">Tambah</a>
	...
	<table border="1">
		...
		<tr>
			...
			<td>
				<a class="button button2" href="edit_kwitansi.php?id=<?php echo $x['id']; ?>&aksi=edit">Edit</a>
				<a class="button button3" href="../proses.php?id=<?php echo $x['id']; ?>&aksi=hapus_kwitansi">Hapus</a>			
			</td>
		</tr>
		<?php } ?>
		<table>
