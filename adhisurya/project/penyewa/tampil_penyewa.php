...
<body>
	...
	<a class="button button1" href="input_penyewa.php">Tambah</a>
	...
	<table border="1">
		...
		<tr>
			<td><?php echo $no++; ?></td>
			<td><?php echo $x['kode_sewa']; ?></td>
			<td><?php echo $x['kode_user']; ?></td>
			<td><?php echo $x['kode_buku']; ?></td>
			<td><?php echo $x['kode_member']; ?></td>
			<td><?php echo $x['tanggal_pinjam']; ?></td>
			<td><?php echo $x['tanggal_kembali']; ?></td>
			<td>
				<a class="button button2" href="edit_penyewa.php?id=<?php echo $x['id']; ?>&aksi=edit">Edit</a>
				<a class="button button3" href="../proses.php?id=<?php echo $x['id']; ?>&aksi=hapus_penyewa">Hapus</a>			
			</td>
		</tr>
		<?php } ?>
		<table>
