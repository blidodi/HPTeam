        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a class="btn btn-primary" href="tampil_buku.php">Back</a>
                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <h4 class="modal-title" id="myModalLabel">View Detail Buku</h4>
                                </div>
                                <div >
                                       <form action="../proses.php?aksi=view_buku" method="post">
                                        <?php
                                            foreach($db->view_buku($_GET['id']) as $print){
                                        ?>
                                            <table class="table table-striped" id="dataTables-example">
                                                <tr>
                                                    <td>Cover Buku</td>
                                                    <td align="center">:</td>
                                                    <td><img src="<?php echo "../image/".$print['foto']; ?>" class="cover"></td>
                                                </tr>
                                                <tr>
                                                    <td>No.</td>
                                                    <td align="center">:</td>
                                               ...
                                               <tr>
                                                    <td>Penulis</td>
                                                    <td align="center">:</td>
                                                    <td><?php echo $print['penulis'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Penerbit</td>
                                                    <td align="center">:</td>
                                                    <td><?php echo $print['penerbit'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Tahun</td>
                                                    <td align="center">:</td>
                                                    <td><?php echo $print['tahun_terbit'] ?></td>
                                                </tr>
                                               <tr>
                                                    <td>Jenis</td>
                                                    <td align="center">:</td>
