...
<body>
	...
	<div id="header">
		<h3><i class="fa fa-user-circle-o" aria-hidden="true"></i> Data Members</h3>	
	</div>	
		<a class="button button1" href="input_member.php"><i class="fa fa-plus-square" aria-hidden="true"></i> Add</a>
	<table border="1">
		<tr>
			...
			<th><i class="fa fa-sort" aria-hidden="true"></i> Alamat</th>
		...
		<tr>
			...
			<td align="center"><?php echo $x['foto']; ?></td>
			<td align="center">
				<a class="button button2" href="edit_member.php?id=<?php echo $x['id']; ?>&aksi=edit"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
				<a class="button button3" href="../proses.php?id=<?php echo $x['id']; ?>&aksi=hapus_member"><i class="fa fa-eraser" aria-hidden="true"></i> </a>	
			</td>
		</tr>
		<?php } ?>
		<table>
