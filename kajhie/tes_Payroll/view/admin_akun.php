...
<head>
    ...
    <title>Kepegawaian |Kelola Akun</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="halaman_utama.php">Kepegawaian</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                         ...
                         <li>
                            <a href="admin_halaman_utama.php"><i class="fa fa-home fa-fw"></i> Halaman Utama </a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Tabel <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin_absensi.php">Absensi Pegawai</a>
                                </li>
                                <li>
                                    <a href="admin_gaji.php">Gaji Pegawai</a>
                                </li>
                            </ul>
                        </li>
                        <li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="taks" placeholder="Username">
                    </div>
                    ...
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input type="text" id="birthdate" value="10/24/1984" />
                    </div>
                </div>
            <!-- /.row -->
            </div>
